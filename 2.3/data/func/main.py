...
pygame.display.set_caption("Ultimate Tic Tac Toe 2.3.0 DEV")
...
class Main:
    ...
    def start():
        ...
        while True:
            ...
            output([f"FPS: {int(fps)}",f"Status: {main['status']}",f"Anim: {main['anim']}",f"Width: {main['width']}",f"Height: {main['height']}"],main['screen'])
