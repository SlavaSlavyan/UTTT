...
class Figures:
    ...
    def small_figures_logic(self,mainself, big_cell: int, small_cell: int) -> int:
        ...
        if mainself.Scenes.game.Logic.cells[big_cell][small_cell] == None or None not in mainself.Scenes.game.Logic.cells[big_cell] and 0 not in mainself.Scenes.game.Logic.cells[big_cell] or None not in mainself.Scenes.game.Logic.cells[big_cell] and 1 not in mainself.Scenes.game.Logic.cells[big_cell]:
            ...
            if mainself.Scenes.game.Logic.cells[big_cell][small_cell] == 0:
            ...
            if mainself.Scenes.game.Logic.cells[big_cell][small_cell] == 1:
    ...
    def big_figures_logic(self,mainself, cell: int) -> int:
        ...
        if mainself.Scenes.game.Logic.cells[cell] == [0,0,0,0,0,0,0,0,0]:
        ...
        elif mainself.Scenes.game.Logic.cells[cell] == [1,1,1,1,1,1,1,1,1]:
    ...
    def fantom_logic(self,mainself):
        ...
        if mainself.Scenes.game.Logic.selected_cell == None:
            ...
            if small_selected_cell != None and mainself.Scenes.game.Logic.cells[mainself.Scenes.game.Logic.selected_cell][small_selected_cell] == None:
