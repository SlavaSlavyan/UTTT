...
class Win:
    ...
    def rect(self,mainself, counter: float):
        ...
        pygame.draw.rect(mainself.Display.screen,mainself.Display.colors[7+mainself.Scenes.game.Logic.win],
                        rect,round(10*z))
        
        self.text(mainself,counter,-50,mainself.Scenes.game.Logic.win,7+mainself.Scenes.game.Logic.win)
